...
class PoliceSupabaseService {
  ...
  // Get single citizen by Firebase user_id
  static Future<Map<String, dynamic>?> getCitizenByUserId(String userId) async {
    try {
      ...
      print('Error fetching citizen by user_id: $e');
      return null;
    }
  }
